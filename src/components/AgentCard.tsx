  ...
  return (
    <div className="lg:col-span-4 space-y-6">
      ...
      >
        <div className="flex items-center mb-5">
          <div className="relative">
            <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-luxury-gold/30">
              <img
            ...
            <div className="absolute -bottom-1 -right-1 bg-luxury-gold text-black w-6 h-6 rounded-full flex items-center justify-center text-xs">
        ...
        <div className="space-y-3 mb-6">
          <a
            ...
            className="flex items-center hover:text-luxury-gold transition-colors group"
          >
            <div className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center mr-3 group-hover:bg-luxury-gold/20 transition-colors">
        ...
        <button className="w-full bg-luxury-gold text-black py-3 rounded-lg font-bold hover:bg-luxury-gold/90 transition-all flex items-center justify-center group">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          <div>
            <input
              ...
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-luxury-gold/50 focus:border-transparent text-sm"
              required
            />
          </div>
          ...
          <div>
            <select
              ...
              onChange={handleChange}
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-luxury-gold/50 focus:border-transparent text-sm bg-white"
              required
            >
      ...
      >
        <a
          href="#"
          className="bg-gray-50 p-4 rounded-lg text-center hover:bg-luxury-gold/10 transition-all group"
        >
